                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="br-wrapper br-theme-css-stars"><select id="profile-rating"
                                                ...
                                                <div class="br-widget"><a href="#" data-rating-value="1"
                                                        data-rating-text="1" class="br-selected br-current"></a><a
                                                        href="#" data-rating-value="2" data-rating-text="2"
                                                        class=""></a><a href="#" data-rating-value="3"
                                                        data-rating-text="3" class=""></a><a href="#"
                                                        data-rating-value="4" data-rating-text="4" class=""></a><a
                                                        href="#" data-rating-value="5" data-rating-text="5"
                                                        class=""></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="w-75 mx-auto mb-3">Bureau Oberhaeuser is a design bureau focused on
                                        Information- and Interface Design. </p>
                                ...
                                <div class="profile-feed">
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <img src="../../../../images/samples/1280x768/12.jpg" alt="sample"
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="../../../../images/faces/face19.jpg" alt="profile"
                                            class="img-sm rounded-circle">
                                        <div class="ms-4">
                                            <h6>
                                                Dylan Silva
