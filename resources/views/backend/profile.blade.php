                            ...
                            <div class="col-lg-4">
                                <div class="border-bottom text-center pb-4">
                                    @if (empty(Auth::user()->foto))
                                        <img src="assets/nophoto/nophoto.jpg" width="" alt="Profile"
                                            class="rounded-circle">
                                    @else
                                        <img src="assets/img/{{ Auth::user()->foto }}" width=""
                                    ...
                                    <p class="w-75 mx-auto mb-3">Seorang {{ Auth::user()->role }} dari website kelola perpustakaan </p>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="profile-feed">
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="backend/images/faces/face1.jpg" alt="profile"
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="backend/images/faces/face2.jpg" alt="profile"
                                            class="img-sm rounded-circle">
                                        <div class="ms-4">
                                            <h6>
                                                Willie Stanley
                                            ...
                                            <img src="backend/images/samples/300x300/1.jpg" alt="sample" class="rounded mw-100">
                                            <p class="small text-muted mt-2 mb-0">
                                                <span>
                                                    <i class="ti-star me-1"></i>4
                                                </span>
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="backend/images/faces/face3.jpg" alt="profile"
                                            class="img-sm rounded-circle">
                                        <div class="ms-4">
                                            <h6>
                                                Dylan Silva
                                            ...
                                            <img src="backend/images/samples/1280x768/5.jpg" alt="sample"
