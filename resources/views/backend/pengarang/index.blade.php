                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning bi bi-eye btn-sm"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal2{{ $pengarang->idpengarang }}">

                                                </button>
                                                <button type="button" class="btn btn-danger bi bi-trash btn-sm"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal3{{ $pengarang->idpengarang }}">
            ...
            <div class="modal fade" id="exampleModal1{{ $pengarang->idpengarang }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="forms-sample" action="{{ route('ubahdata', $pengarang->idpengarang) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-floating">
            ...
            <div class="modal fade" id="exampleModal3{{ $pengarang->idpengarang }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="forms-sample" action="{{ route('hapusdata', $pengarang->idpengarang) }}"
                                method="POST">
                                @csrf
                                @method('delete')
                                <div class="form-floating">
