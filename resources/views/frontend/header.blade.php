    ...
    <header id="header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="main-logo">
                        <a href="{{ url('/home') }}"><img src="{{ asset('frontend/assets/images/main-logo.png') }}"
                                alt="logo"></a>
                    </div>
                ...
                <div class="col-md-10">
                    ...
                    <nav id="navbar">
                        <div class="main-menu stellarnav">
                            <ul class="menu-list">
                                <li class="menu-item {{ $title === 'home' ? 'active' : '' }}"><a
                                        href="{{ url('/') }}">Home</a></li>
                                <li class="menu-item {{ $title === 'featured' ? 'active' : '' }}"><a
                                        href="{{ url('/bukunya') }}" class="nav-link">Featured</a></li>
                                <li class="menu-item {{ $title === 'populer' ? 'active' : '' }}"><a
